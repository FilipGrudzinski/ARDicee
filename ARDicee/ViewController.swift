...
//  ARDicee
//
//  Created by Filip on 05/12/2018.
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if let touch = touches.first {
            ...
            if let hitResults = results.first {
                ...
                // Create a new scene
                let diceSceen = SCNScene(named: "art.scnassets/diceCollada.scn")!
                
                if let diceNode = diceSceen.rootNode.childNode(withName: "Dice", recursively: true) {
    ...
    func rollAll() {
        if !diceArray.isEmpty {
            for dice in diceArray {
                ...
                //dice.removeFromParentNode() usuwanie wszystkich kostek
            }
    ...
    func roll(dice: SCNNode) {
        ...
        let randomX = Float(arc4random_uniform(4) + 1) * (Float.pi)
        
        let randomZ = Float(arc4random_uniform(4) + 1) * (Float.pi)
